app.controller('ctrl', function($scope, $http,$filter) {
    ...
    $scope.startPage = 1;
    $scope.pageCount = "25";
    $scope.showBillType = "Show blank";
    $scope.showBillTypeSend = "all";
   // $scope.pagination = null;
    ...
    $scope.projectList = function(page){
        ...
        $http({
            method:'post',
            url:'/allProject?page='+page+'&pageType=billing',
            data:submitData,
            headers: {
    ...
    $scope.submitData = function(){
        let dataToFind = {
            ...
            filter:{},
            showBillType:$scope.showBillTypeSend
        };
    ...
    $scope.setPagination = function(){
        ...
        $http({
            method:'post',
            url:'/allProject?type=count&pageType=billing',
            data:submitData,
            headers: {
                'authorization': localStorage.token
            }
    ...
    $scope.exportTable = function(){
        ...
        $http({
            method:'post',
            url:'/allProject?type=download&pageType=billing',
            data:submitData,
            headers: {
                'authorization': localStorage.token,
    ...
    $scope.changeShowBillType = function(){
        if($scope.showBillType == "Show blank"){
            $scope.showBillType = "Show all";
            $("input[name=poNumber]").val('');
            $("input[name=shippmentNo]").val('');
            $("input[name=esarOnScs]").val('');
            $("input[name=pacOnScs]").val('');
            $("input[name=wccStatus]").val('');
            $("input[name=grn_iaStatus]").val('');
            $("input[name=invoiceStatus]").val('');
            $scope.showBillTypeSend = "blank";
        }
        else{
            $scope.showBillType = "Show blank";
            $scope.showBillTypeSend = "all";
