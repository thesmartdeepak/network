   ...
   // $scope.pagination = null;
    ...
    $scope.claimAdvanceList = function(page){
        ...
        $http({
            ...
            // console.log($scope.claimAdvances);
        });
    }
...
console.log(" dataToFind.filter", dataToFind.filter);
            }
        });
...
// console.log("dataToFind.filter[name]",dataToFind);
    ...
    $scope.setPagination = function(){
        ...
        $http({
            method:'post',
            url:'/allclaimMonthly?type=count',
            data:submitData,
            headers: {
                'authorization': localStorage.token
            }
    ...
    $scope.exportTable = function(){
        ...
        $http({
            method:'post',
            url:'/allclaimMonthly?type=download&pageType=project',
            data:submitData,
            headers: {
                'authorization': localStorage.token,
             },
