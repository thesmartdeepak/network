            ...
            $http({
                ...
                for (x in response.data.data.projectDetails) {
                    ...
                    $scope.project[row._id] = row;
                        ...
                        // console.log("$scope.project[row.projectCode]",$scope.project[row.projectCode]);
                ...
                for (x in response.data.data.cabDetails) {
                    var row = response.data.data.cabDetails[x];
                     $scope.checkPrject(row._id);
                        $scope.project[row._id].cab = row.totalAmount.toFixed(3);
                ...
                for (x in response.data.data.kitDetails) {
                    ...
                    //
                        ...
                        $scope.project[row.projectCode]["kit"] += row.kitRent;
                        $scope.project[row.projectCode].investment += row.totalAmount;
                        // console.log("$scope.project[row.projectCode].investment",$scope.project[row.projectCode].investment);
